...
type Props = StackProps & {
  ...
  exp_title: string;
  years: string;
  in_team_title: string;
  join_our_team_button_title: string;
};
    ...
    >
      ...
      <Stack spacing={1}>
        <Stack direction="row" spacing={1}>
          ...
          >
            <StatsBlock title={in_team_title}>
              <Typography
                fontFamily="e-Ukraine"
                fontSize="2.5rem"
                color="#fff"
        ...
        >
          <JoinOurTeamButton button_title={join_our_team_button_title} />
        </motion.div>
      </Stack>
    </MotionStack>
  );
